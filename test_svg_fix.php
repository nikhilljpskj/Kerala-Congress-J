...
$logoPath = VIEWS_PATH . DIRECTORY_SEPARATOR . 'admin' . DIRECTORY_SEPARATOR . 'logo_kc.svg';
...
try {
    ...
    $mpdf->WriteHTML($html);
    $mpdf->Output('final_svg_fix_id.pdf', 'F');
    echo "Success: final_svg_fix_id.pdf generated.";
} catch (Exception $e) {
